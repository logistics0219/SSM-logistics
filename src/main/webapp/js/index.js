document.write('<script src="jquery-2.2.1.min.js" type="text/javascript" charset="utf-8"></script>');
$(function () {
    var my=[{"value": 900.58,name: '张家口',itemStyle: {normal: {color: '#f845f1'}}},{"value": 900.58,name: '张家口',itemStyle: {normal: {color: '#f845f1'}}},{"value": 900.58,name: '张家口',itemStyle: {normal: {color: '#f845f1'}}}];
    echart_1();
    echart_2();
              ...
              /*  mydata=data;*/
                ...
                option = {
                    ...
                    legend: {
                        x: 'center',
                        y: '15%',
                        data:[],/*[ '合肥', '蚌埠', '淮南','六安', '滁州', '阜阳','亳州','淮北', '宿州','安庆','巢湖', '马鞍山','铜陵','芜湖', '池州','宣城','黄山'],*/
                        icon: 'circle',
                        textStyle: {
                            color: '#fff',
                        }
